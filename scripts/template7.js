const handleOutputImageForTemplate7 = (uploadedFile, selectedTemplateSrc) => {
    ...
    image.onload = () => {
        ...
        ctxText1.font = "400 75px 'Sanchez', serif";
        ...
        ctxText2.font = "400 75px 'Sanchez', serif";
        ...
        mergeImages(
            [
                ...
                { src: canvasText1.toDataURL(), y: 115, x: 0 },
                { src: canvasText2.toDataURL(), y: 200, x: 0 },
                { src: canvas.toDataURL(), x: 55, y: 386 }
            ],
            {
                width: 1080,
                heigh: 1080
